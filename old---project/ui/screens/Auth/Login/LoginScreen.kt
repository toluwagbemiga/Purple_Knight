// Ensure this package declaration matches your file's directory structure EXACTLY
...
// Ensure this import path is correct based on where LoginScreenState is defined
import com.bit.purple.project.ui.screens.auth.login.LoginScreenState
import com.bit.purple.project.ui.theme.PrimaryColor

// Add this to your imports at the top of LoginScreen.kt
...
fun LoginContent(
    ...
    Column(
        ...
        Row(
            ...
            // FIXED: Correct string resource ID
        ...
        // FIXED: Renamed 'label' to 'labelText' and 'errorMessage' to 'supportingText'
        AuthTextField(
            value = state.email,
        ...
        Row(
            ...
            // FIXED: Changed to Arrangement.End
        ...
        Spacer(modifier = Modifier.weight(1f)) // Use weight to push the button to the bottom
        ...
        Row(
            ...
            Text(
                ...
                // FIXED: Removed the self-navigating clickable modifier to prevent bug
                modifier = Modifier,
                color = PrimaryColor,
                fontWeight = FontWeight.Bold,
                style = MaterialTheme.typography.bodyMedium
